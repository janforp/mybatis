...
import org.apache.ibatis.domain.zoo.Animal;
...
public class MetaObjectTest {
    ...
    public void test() {
        ...
        MetaObject metaObject = MetaObject.forObject(animal, new DefaultObjectFactory(), new DefaultObjectWrapperFactory());
        metaObject.setValue("name", "张三");
        assertEquals("张三", animal.getName());
    }
    ...
    public void testCollection() {
        ...
        MetaObject metaObject = MetaObject.forObject(list, new DefaultObjectFactory(), new DefaultObjectWrapperFactory());
        metaObject.add(animal);
        assertEquals("里斯", list.get(0).getName());
    }
    ...
    public void testMap() {
        ...
        MetaObject metaObject = MetaObject.forObject(map, new DefaultObjectFactory(), new DefaultObjectWrapperFactory());
        metaObject.setValue("王五的爸爸", animal);
        assertEquals("王五", map.get("王五的爸爸").getName());
    }
    ...
    public void testTokenizer() {
        ...
        assertEquals("tokenizer", animal.getParent().getName());
    }
}
